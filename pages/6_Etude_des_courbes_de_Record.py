...
if 'df_raw' in st.session_state:
        ...
        if vap_records_dict:
            ...
            if not df_current_curve_records.empty:
                ...
                try:
                    ...
                    st.success(f"Records VAP sauvegardés pour {activity_name}. Rechargement de l'historique...")
    ...
    if not df_historical_curves.empty:
        ...
        if not df_vap_history.empty:
            ...
            # --- A. GRAPHIQUE 1 : Le Record Absolu (Une seule courbe) ---
            st.markdown("### 🥇 Record de Performance Absolu (Tous les Temps)")
            ...
            st.info("Sélectionnez les mois que vous souhaitez comparer pour visualiser la progression de votre meilleure forme.")
            ...
            if selected_months:
                ...
                plot_vap_curve_comparative(
                    courbes_a_tracer,
                    title=f"Meilleurs Profils de Performance par Mois pour {sport_type}",
